/**
 * Streaming preview component for artifact content
 * Shows a loading state or raw streaming content when artifact is being generated
 */
...
export function ArtifactStreamingPreview({
  ...
  // Loading state - not enough content yet
  return (
